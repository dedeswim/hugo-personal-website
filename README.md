...
I used [`cookieless-google-analytics`](https://github.com/Foture/cookieless-google-analytics) by [Foture](https://github.com/Foture) to implement cookieless Google Analytics (didn't say?).
